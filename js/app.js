...
function youLose() {
    ...
    Swal.fire({
        ...
        confirmButtonText: '<a class="noLink" href="https://jimenamonllor.github.io/MemoTest-JS/">Jugá otra vez</a>',
...
function playAgain() {
    Swal.fire({
        ...
        showDenyButton: true,
        confirmButtonText: '<a class="noLink" href="https://jimenamonllor.github.io/MemoTest-JS/">Jugar otra vez</a>',
